...
if __name__ == "__main__":
    ...
    print(" -- og model")
    for tidx in range(5):
        print( result['susceptible'][tidx], result['exposed'][tidx], result['infectious'][tidx] )
    print("\n -- new model")
    for tidx in range(5):
        print( new_result['susceptible'][tidx], new_result['exposed'][tidx], new_result['infectious'][tidx] )
