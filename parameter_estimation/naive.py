...
parameters = [
    # [ "parameter name", x0, x1, n_samples ] parses to [x0,x1]
    # inclusive with n_samples points
    ["R0", 2., 9., 8],
...
if __name__ == "__main__":
    ...
    for param in parameters:
        full_parameters.append(
            [param[0]] + list(np.linspace(param[1], param[2], param[3])))
    ...
    print(model_params)
    val = calculate_likelihood_for_model(model_params, cases.deaths)
    print(" - likelihood: {0:g}".format(val))
